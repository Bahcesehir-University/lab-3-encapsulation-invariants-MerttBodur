...
public:
    ...
    explicit Temperature(double celsius) {
        ...
        if (celsius < -273.15) 
        {
            throw invalid_argument("Temperature can not be smaller than -273.15!");
        }
        celsius_ = celsius;
    }
...
public:
    ...
    void deposit(double amount) {
        ...
        if (amount <= 0) 
        {
            throw invalid_argument("deposit amount can not be 0 or smaller!");
        }
        balance_ += amount;
    }
    ...
    void withdraw(double amount) {
        ...
        if (amount <= 0)
        {
            throw invalid_argument("withdraw amount can not be 0 or smaller!");
        }
        if (amount > balance_)
        {
...
public:
    ...
    void change(const string& oldPassword, const string& newPassword) {
        ...
        {
            throw invalid_argument("oldPassword does not match!");
        }
